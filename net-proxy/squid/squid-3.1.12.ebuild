...
inherit eutils pam toolchain-funcs autotools linux-info systemd systemd-local
...
IUSE="caps ipv6 pam ldap samba sasl kerberos nis radius ssl snmp selinux logrotate test \
	...
	elibc_uclibc kernel_linux +epoll tproxy systemd"
...
src_install() {
	...
	if use systemd ; then
		doservices "${FILESDIR}/${PN}.service"
		doservices "${FILESDIR}/${PN}.socket"
	fi
}
