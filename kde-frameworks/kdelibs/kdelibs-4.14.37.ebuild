...
spell test cpu_flags_x86_sse cpu_flags_x86_sse2 ssl +udev +udisks +upower zeroconf webkit"
...
PATCHES=(
	...
	"${FILESDIR}/remove-dep-on-dep-libs.patch"
)
...
src_configure() {
	local mycmakeargs=(
		...
		-DWITH_PLASMA4SUPPORT=OFF
		-DWITH_QCA2=OFF
		-DWITH_PolkitQt-1=OFF
